...
public class MushroomPicker {
    ...
    public static void main(String[] args) {
        ...
        mushroomPicker.getMaxMushrooms(new int[]{2, 3, 7, 5, 1, 3, 9}, 4, 6);

    }

    /**
     * @param mushrooms        number of mushrooms in each spot.
     * @param currentSpot      - index of current post.
     * @param noOfMovesAllowed - no of moves allowed to collect maximum nunber of possible
     *                         mushrooms.
